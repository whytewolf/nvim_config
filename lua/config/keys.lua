...
keymap.set('n', '<f3>', function()
  dapui.toggle()
end, { desc = 'Open debug panels' })
keymap.set('n', '<f5>', function()
  dap.continue()
end, { desc = 'Run debug' })
keymap.set('v', '<f5>', function()
  dapui.eval()
end, { desc = 'Evalue selected expression' })
...
-- find
keymap.set('n', '<leader>e', '<CMD>Oil<CR>', { desc = 'Open directory' })
...
keymap.set('n', '<leader>tgp', function()
  Snacks.picker.gh_pr()
end, { desc = 'Github PR View' })
keymap.set('n', '<leader>tgI', function()
  Snacks.picker.gh_issue { state = 'all' }
end, { desc = 'Github issues (all)' })
keymap.set('n', '<leader>tgP', function()
  Snacks.picker.gh_pr { state = 'all' }
end, { desc = 'Github PR View (all)' })
